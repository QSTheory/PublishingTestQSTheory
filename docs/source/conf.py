...
html_theme_options = dict(
    repository_url='https://github.com/QSTheory/PublishingTestQSTheory',
    ...
    switcher=dict(
        ...
        # json_url="https://QSTheory.github.io/PublishingTestQSTheory/versions.json", # when published
        version_match=os.getenv("VERSION", "main"),
    ),
    icon_links=[
        {
            "name": "GitHub",
            "url": "https://github.com/QSTheory/PublishingTestQSTheory",
